...
public class Refrigerator2GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Refrigerator2GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinatoFurnitureModMenus.REFRIGERATOR_2_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 35) {
			...
			private int x = Refrigerator2GUIMenu.this.x;
			private int y = Refrigerator2GUIMenu.this.y;
		}));
