...
public class Refrigerator1GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Refrigerator1GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinatoFurnitureModMenus.REFRIGERATOR_1_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 16, 35) {
			...
			private int x = Refrigerator1GUIMenu.this.x;
			private int y = Refrigerator1GUIMenu.this.y;
		}));
