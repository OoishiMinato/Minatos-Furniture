...
package net.mcreator.minatosfurniture.world.inventory;
...
import net.mcreator.minatosfurniture.procedures.OvenFireProProcedure;
...
public class OvenMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public OvenMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinatoFurnitureModMenus.OVEN.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 43, 26) {
			...
			private int x = OvenMenu.this.x;
			private int y = OvenMenu.this.y;
		}));
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 79, 44) {
			...
			public boolean mayPlace(ItemStack stack) {
				return MinatoFurnitureModItems.FUEL.get() == stack.getItem();
			}
		}));
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof OvenMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			OvenFireProProcedure.execute(world, entity);
		}
	}
}
