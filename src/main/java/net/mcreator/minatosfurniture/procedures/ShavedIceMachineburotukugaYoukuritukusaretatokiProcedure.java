...
public class ShavedIceMachineburotukugaYoukuritukusaretatokiProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Blocks.ICE.asItem()) {
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = MinatoFurnitureModBlocks.SHAVED_ICE_MACHINE_IN_ICE.get().defaultBlockState();
		...
		} else if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == Blocks.ICE.asItem()) {
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = MinatoFurnitureModBlocks.SHAVED_ICE_MACHINE_IN_ICE.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
