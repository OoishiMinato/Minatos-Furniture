...
public class Bath2burotukugaYoukuritukusaretatokiProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.WATER_BUCKET) {
			...
			if (!(new Object() {
				...
				MinatoFurnitureMod.queueServerWork(1, () -> {
					if (entity instanceof LivingEntity _entity) {
			...
			}
			{
				...
				BlockState _bs = MinatoFurnitureModBlocks.BATH_3.get().defaultBlockState();
